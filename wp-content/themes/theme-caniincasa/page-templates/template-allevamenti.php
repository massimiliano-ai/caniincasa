                        ...
                        <div class="item-content">
                            ...
                            ?>
                                <div class="item-contacts">
                                    <?php if ( $telefono ): ?>
                                        <a href="tel:<?php echo esc_attr( preg_replace( '/[^0-9+]/', '', $telefono ) ); ?>" class="contact-item">
                                            <span class="icon">📞</span>
                                        </a>
                                    <?php endif; ?>
                                    ...
                                    <?php if ( $sito_web ): ?>
                                        <a href="<?php echo esc_url( $sito_web ); ?>" target="_blank" rel="noopener" class="contact-item">
                                            <span class="icon">🌐</span>
                                        </a>
                                    <?php endif; ?>
                                </div>
